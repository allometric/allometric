...
Motivated users are entirely capable of submitting models, provided they are
comfortable using `git` pull requests.

1. Fork and then clone the [`models`](https://github.com/allometric/models.git)
...
Users that are savvy with `git` are free to submit pull requests to the 
`allometric/models` repository. This is a step-by-step instruction for this
purpose.
