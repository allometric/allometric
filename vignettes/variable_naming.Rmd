...
3. f: foliage
4. c: crown
5. n: stand - used to refer to stand-level variables (typically used as covariates)
6. p: plot - used to refer to plot-level variables (typically used as covariates)
