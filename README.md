...
# allometric <picture><source media="(prefers-color-scheme: dark)" srcset="https  "><source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/brycefrank/allometric/master/man/figures/allo2.svg"><img alt="Isometric logo of a tree" height="210" width="165" align="right"></picture>
...
[![](https://img.shields.io/badge/devel%20version-1.0.0.9008-blue.svg)](https://github.com/brycefrank/allometric)
...
In total **`allometric` contains 1606 models across 49 publications**,
