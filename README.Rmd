...
[Contributing a Model](https://allometric.github.io/allometric/articles/installing_a_model.html) vignette.
...
```
 ...
 Refer to the [Reference](https://allometric.github.io/allometric/reference/index.html)
...
only needs to be ran at installation or following any package updates. The user
can then call `load_models()` to load all available allometric models into
memory.
